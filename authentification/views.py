...
def index(request):
    ...
    user_avg=str(Profil.objects.all().aggregate(Avg('user'))['user__avg'])
    ...
    objetif_avg=str(Profil.objects.all().aggregate(Avg('objetif'))['objetif__avg'])
